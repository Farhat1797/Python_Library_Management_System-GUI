...
class AddMember(Toplevel):
    def __init__(self):
        ...
        self.ent_name.insert(0,'Please enter a person name')
        ...
        self.ent_phone.insert(0, 'Please enter person Number')
        self.ent_phone.place(x=150, y=85)
        #Button
        button=Button(self.bottomFrame,text='Add person',command=self.addMember)
